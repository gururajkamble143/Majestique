...
@Entity
public class Shirts_table {
	
	public Shirts_table() {
		super();
	}
	public Shirts_table(int id, String title, int price_dis, int price_ori, int off, String style_name, String color,
			String category, String pattern, String image1, String image2, String image3, String image4,
			String image5) {
		super();
		this.id = id;
		this.title = title;
	...
	public String toString() {
		return "Shirts_table [id=" + id + ", title=" + title + ", price_dis=" + price_dis + ", price_ori=" + price_ori
