...
@Entity
public class Dresses_table {

	public Dresses_table() {
		super();
	}
	public Dresses_table(int id, String title, int price_dis, int price_ori, int off, String style_name,
	...
	public String toString() {
		return "Dresses_table [id=" + id + ", title=" + title + ", price_dis=" + price_dis + ", price_ori=" + price_ori
