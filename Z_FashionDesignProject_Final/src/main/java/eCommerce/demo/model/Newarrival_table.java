...
@Entity
public class Newarrival_table {
	
	public Newarrival_table() {
		super();
	}
	public Newarrival_table(int id, String title, int price_dis, int price_ori, int off, String style_name,
	...
	public String toString() {
		return "Newarrival_table [id=" + id + ", title=" + title + ", price_dis=" + price_dis + ", price_ori="
