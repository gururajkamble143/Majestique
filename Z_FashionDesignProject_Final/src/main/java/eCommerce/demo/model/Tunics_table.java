...
@Entity
public class Tunics_table {

	public Tunics_table() {
		super();
	}
	
	public Tunics_table(int id, String title, int price_dis, int price_ori, int off, String style_name, String color,
	...
	public String toString() {
		return "Tunics_table [id=" + id + ", title=" + title + ", price_dis=" + price_dis + ", price_ori=" + price_ori
