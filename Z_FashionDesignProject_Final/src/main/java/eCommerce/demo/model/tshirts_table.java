...
@Entity
public class tshirts_table {
	
	
	public tshirts_table() {
		super();
	}
	
	
	public tshirts_table(int id, String title, int price_dis, int price_ori, int off, String style_name,
	...
	public String toString() {
		return "tshirts_table [id=" + id + ", title=" + title + ", price_dis=" + price_dis + ", price_ori=" + price_ori
