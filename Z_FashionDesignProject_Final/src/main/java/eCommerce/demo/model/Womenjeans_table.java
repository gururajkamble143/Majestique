...
@Entity
public class Womenjeans_table {

	public Womenjeans_table() {
		super();
	}
	public Womenjeans_table(int id, String title, int price_dis, int price_ori, int off, String style_name,
	...
	public String toString() {
		return "Womenjeans_table [id=" + id + ", title=" + title + ", price_dis=" + price_dis + ", price_ori="
