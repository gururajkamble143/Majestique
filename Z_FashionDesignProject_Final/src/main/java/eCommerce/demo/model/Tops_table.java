...
@Entity
public class Tops_table {

	public Tops_table() {
		super();
	}
	public Tops_table(int id, String title, int price_dis, int price_ori, int off, String style_name, String color,
	...
	public String toString() {
		return "Tops_table [id=" + id + ", title=" + title + ", price_dis=" + price_dis + ", price_ori=" + price_ori
