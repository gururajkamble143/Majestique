...
@Entity
public class Trousers_table {
	
	public Trousers_table() {
		super();
	}
	public Trousers_table(int id, String title, int price_dis, int price_ori, int off, String style_name,
	...
	public String toString() {
		return "Trousers_table [id=" + id + ", title=" + title + ", price_dis=" + price_dis + ", price_ori=" + price_ori
