...
@Entity
public class Womenshirts_table {

	public Womenshirts_table() {
		super();
	}
	public Womenshirts_table(int id, String title, int price_dis, int price_ori, int off, String style_name,
	...
	public String toString() {
		return "Womenshirts_table [id=" + id + ", title=" + title + ", price_dis=" + price_dis + ", price_ori="
				+ price_ori + ", off=" + off + ", style_name=" + style_name + ", color=" + color + ", category="
				+ category + ", pattern=" + pattern + ", image1=" + image1 + ", image2=" + image2 + ", image3=" + image3
