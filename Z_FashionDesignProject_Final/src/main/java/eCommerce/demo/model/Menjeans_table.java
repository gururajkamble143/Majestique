...
@Entity
public class Menjeans_table {

	public Menjeans_table() {
		super();
	}
	
	public Menjeans_table(int id, String title, int price_dis, int price_ori, int off, String style_name,
	...
	public String toString() {
		return "Menjeans_table [id=" + id + ", title=" + title + ", price_dis=" + price_dis + ", price_ori=" + price_ori
