...
<head>
    ...
    <title>Majestique | Men Jeans</title>
</head>
<body>
    ...
    <div class="main-grid">
        <%
            ...
            List<Menjeans_table> listmenjeans = (List<Menjeans_table>)request.getAttribute("listmenjeans");
            
            for(Menjeans_table b:listmenjeans)
            {
        %>

                <div class="col">
                    <a href="/menjeansdetails/<%= b.getId()%>"><img src="jspPages/jspImages/images/<%=b.getImage1()%>" alt="" style="height: 250px; width: 250px;"></a>
                    <p><%= b.getTitle() %></p>
