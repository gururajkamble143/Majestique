...
<head>
    ...
    <title>Majestique | Women Jeans</title>
</head>
<body>
    ...
    <div class="main-grid">
        <%
            ...
            List<Womenjeans_table> listwomenjeans = (List<Womenjeans_table>)request.getAttribute("listwomenjeans");
            
            for(Womenjeans_table b:listwomenjeans)
            {
        %>

                <div class="col">
                    <a href="/wjeansdetails/<%= b.getId()%>"><img src="jspPages/jspImages/images/<%=b.getImage1()%>" style="width: 250px;"></a>
                    <p><%= b.getTitle() %></p>
