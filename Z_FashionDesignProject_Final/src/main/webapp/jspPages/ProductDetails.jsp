...
<body>
	<form action="/ProductDetails" method="post" enctype="multipart/form-data">
		...
		image 1 : <br><input type="file" name="image1"><br>
		image 2 : <br><input type="file" name="image2"><br>
		image 3 : <br><input type="file" name="image3"><br>
		image 4 : <br><input type="file" name="image4"><br>
		image 5 : <br><input type="file" name="image5"><br>
		
		<br><br><br><input type="submit" name="id"><br>
