...
<head>
    ...
    <title>Majestique | Women Shirts</title>
</head>
<body>
    ...
    <div class="main-grid">
        <%
            ...
            List<Womenshirts_table> listwomenshirts = (List<Womenshirts_table>)request.getAttribute("listwomenshirts");
            
            for(Womenshirts_table b:listwomenshirts)
            {
        %>

                <div class="col">
                    <a href="/wshirtsdetails/<%= b.getId()%>"><img src="jspPages/jspImages/images/<%=b.getImage1()%>" alt="" style="width: 250px;"></a>
                    <p><%= b.getTitle() %></p>
