<%@page import="eCommerce.demo.model.Womenshirts_table"%>
<%@page import="eCommerce.demo.model.Womenjeans_table"%>
<%@page import="eCommerce.demo.model.Shirts_table"%>
<%@page import="eCommerce.demo.model.Menjeans_table"%>
<%@page import="eCommerce.demo.model.Tunics_table"%>
<%@page import="eCommerce.demo.model.Trousers_table"%>
<%@page import="eCommerce.demo.model.Tops_table"%>
<%@page import="eCommerce.demo.model.Dresses_table"%>
...
<body>
    ...
    <header>
        ...
        <div class="dropdown_menu open">
            ...
            <li><a href="#">EXPLORE MORE</a></li>
            <li><a href="#">STORES</a></li>
            <li><a href="/getCart"><i class="fa-solid fa-bag-shopping"></i></li></a>
    ...
    <!-- ########################################################################## -->
        ...
        <%        
            Womenshirts_table b = (Womenshirts_table)request.getAttribute("wshirt");   
        %>
...
<section id="prodetails" class="section-p1">
    ...
    <div class="single-pro-details">
        ...
        <div class="buybut">
            <a href="/addtocart"><button class="normal" id="btn1">Add to Cart</button></a><br>
