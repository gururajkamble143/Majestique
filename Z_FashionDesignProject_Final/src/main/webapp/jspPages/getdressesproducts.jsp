...
<head>
    ...
    <title>Majestique | Dresses</title>
</head>
<body>
    ...
    <div class="main-grid">
        <%
            ...
            List<Dresses_table> listdresses = (List<Dresses_table>)request.getAttribute("listdresses");
            
            for(Dresses_table b:listdresses)
            {
        %>
        		
				<%-- <%=b.getImage1()%> --%>
                <div class="col">
                	<!-- <img alt="image" src="jspPages/jspImages/images/girlsdress/21.jpg" style="height: 250px; width: 250px;"> -->
                    <a href="/dressesdetails/<%= b.getId()%>"><img src="jspPages/jspImages/images/<%=b.getImage1()%>" alt="" style=" width: 250px;"></a>
                    <p><%= b.getTitle() %></p>
