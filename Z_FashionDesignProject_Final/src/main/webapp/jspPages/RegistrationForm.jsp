...
<body>
    ...
    <div class="regform">
        ...
        <form action="/adduser" class="regnewform" method="post">
            <p>Name</p>
            <input type="text" name="name" placeholder="User Name">
            <p>Email</p>
            <input type="text" name="email" placeholder="Email">
            <p>Apartment / Lane</p>
            <input type="text" name="lane" placeholder="Apartment / Lane">
            <p>Taluka</p>
            ...
            <input type="text" name="repass" placeholder="Re-enter Password">
            <br> <br> <br>
