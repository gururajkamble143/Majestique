...
<body>
    ...
    <div class="main-grid">
        <%
            ...
            List<Tunics_table> listtunics = (List<Tunics_table>)request.getAttribute("listtunics");
            
            for(Tunics_table b:listtunics)
            {
        %>

                <div class="col">
                    <a href="/tunicsdetails/<%= b.getId()%>"><img src="jspPages/jspImages/images/<%=b.getImage1()%>" alt="" style="width: 250px;"></a>
                    <p><%= b.getTitle() %></p>
