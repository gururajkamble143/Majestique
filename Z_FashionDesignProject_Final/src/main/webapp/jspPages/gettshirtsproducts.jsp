...
<head>
    ...
    <title>Majestique | T-Shirts</title>
</head>
<body>
    ...
    <div class="main-grid">
        <%
            ...
            List<tshirts_table> listshirts = (List<tshirts_table>)request.getAttribute("listshirts");
            
            for(tshirts_table b:listshirts)
            {
        %>

                <div class="col">
                    <a href="/tshirtsdetails/<%= b.getId()%>"><img src="jspPages/jspImages/images/<%=b.getImage1()%>" alt="" style="width: 250px;"></a>
                    <p><%= b.getTitle() %></p>
