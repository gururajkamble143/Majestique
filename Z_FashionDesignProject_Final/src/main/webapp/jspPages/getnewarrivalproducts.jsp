...
<head>
    ...
    <title>Majestique | New Arrival</title>
</head>
<body>
    ...
    <div class="main-grid">
        <%
            ...
            List<Newarrival_table> listnewarrival = (List<Newarrival_table>)request.getAttribute("listnewarrival");
            
            for(Newarrival_table b:listnewarrival)
            {
        %>

                <div class="col">
                    <a href="/newarrdetails/<%= b.getId()%>"><img src="jspPages/jspImages/images/<%=b.getImage1()%>" alt="" style="width: 250px;"></a>
                    <p><%= b.getTitle() %></p>
