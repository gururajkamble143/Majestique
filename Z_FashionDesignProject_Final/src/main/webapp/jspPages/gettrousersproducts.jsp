...
<head>
    ...
    <title>Majestique | Trousers</title>
</head>
<body>
    ...
    <div class="main-grid">
        <%
            ...
            List<Trousers_table> listtrousers = (List<Trousers_table>)request.getAttribute("listtrousers");
            
            for(Trousers_table b:listtrousers)
            {
        %>

                <div class="col">
                    <a href="/trousersdetails/<%= b.getId()%>"><img src="jspPages/jspImages/images/<%=b.getImage1()%>" alt="" style="width: 250px;"></a>
                    <p><%= b.getTitle() %></p>
