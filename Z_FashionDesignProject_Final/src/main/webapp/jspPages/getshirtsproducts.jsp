...
<body>
    ...
    <div class="main-grid">
        <%
            ...
            List<Shirts_table> listshirts = (List<Shirts_table>)request.getAttribute("listshirts");
            
            for(Shirts_table b:listshirts)
            {
        %>

                <div class="col">
                    <a href="/shirtsdetails/<%= b.getId()%>"><img src="jspPages/jspImages/images/<%=b.getImage1()%>" alt="" style="width: 250px;"></a>
                    <p><%= b.getTitle() %></p>
